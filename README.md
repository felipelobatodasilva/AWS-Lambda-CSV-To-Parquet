...
### Checking Folders in S3 for transformation <a name="creatingfoldersins3"></a>
...
### Creating and Running Script for transformation <a name="scriptfortransformation"></a>
...
1. Go to "lambdaconvertion" bucket
